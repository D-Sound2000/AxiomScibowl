...
export function Component({ onEnter, onPlay }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1d18] via-black to-[#2a2e26] text-[#e6e1d7] overflow-hidden relative w-full">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-8 py-12 md:px-16 md:py-20">
        <div className="text-center">
          ...
          >
            ...
            <span className="word" data-delay="400"><b>AXIOM</b></span>{" "}
            <span className="word" data-delay="600">-</span>{" "}
            <span className="word" data-delay="800">Train</span>{" "}
            <span className="word" data-delay="1000">smarter.</span>{" "}
            <span className="word" data-delay="1200">Win</span>{" "}
            <span className="word" data-delay="1400">faster.</span>
          </h2>
          <div
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          {(onEnter || onPlay) && (
            <div
              className="hero-cta-row mt-12 flex justify-center opacity-0"
              style={{ animation: "word-appear 0.9s ease-out forwards", animationDelay: "4.35s" }}
            >
              {onEnter && (
                <LiquidButton onClick={onEnter} size="xxl" className="hero-liquid-cta">
                  <span className="hero-liquid-text">FLASHCARDS</span>
                  <span className="hero-liquid-arrow">-&gt;</span>
                </LiquidButton>
              )}
              {onPlay && (
                <LiquidButton onClick={onPlay} size="xxl" className="hero-liquid-cta hero-liquid-secondary">
                  <span className="hero-liquid-text">GAME READER</span>
                  <span className="hero-liquid-arrow">-&gt;</span>
                </LiquidButton>
              )}
            </div>
        ...
        <div className="text-center">
          ...
          <h2
            ...
            style={{ color: colors[200] }}
          >
            <span className="word" data-delay="4400">Frequency</span>{" "}
            <span className="word" data-delay="4550">analysis,</span>{" "}
            <span className="word" data-delay="4700">active</span>{" "}
            <span className="word" data-delay="4850">recall,</span>{" "}
            <span className="word" data-delay="5000">competition-grade</span>{" "}
            <span className="word" data-delay="5150">insights.</span>
          </h2>
          <div
      ...
      <div
        ...
        style={{ background: `radial-gradient(circle, ${colors[500]}22 0%, transparent 100%)` }}
      ></div>
    </div>
  );
}
